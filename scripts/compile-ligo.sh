...
###################################
echo "Compiling the main contract."
###################################


ligo compile contract $MAIN_FILE --entry-point main
...
tezos-client $protocol_arg convert data compiled_contract, "from", "michelson", "to", "binary")
