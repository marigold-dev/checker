...
[@inline] let ensure_valid_fa2_token (n: fa2_token_id): unit =
  if n = kit_token_id || n = lqt_token_id
  then ()
  else failwith "FA2_TOKEN_UNDEFINED"

[@inline] let ledger_issue_kit
    (st, addr, amnt: fa2_state * address * kit) : fa2_state =
...
[@inline] let ledger_issue_then_withdraw_kit
    (st, addr, amnt_to_issue, amnt_to_withdraw: fa2_state * address * kit * kit) : fa2_state =
...
[@inline] let ledger_issue_lqt
    (st, addr, amnt: fa2_state * address * lqt) : fa2_state =
